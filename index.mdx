---
title: "Overview"
description: "Vampauth is a free licensing and monetisation platform for game script developers. Manage keys, bind them to hardware, and gate free keys behind checkpoint links."
...
Vampauth handles licensing and monetisation for game scripts. Two sides:

- **Developers** register a project, issue keys, bind them to hardware, and earn from checkpoint completions.
- **End users** complete a short ad/offer flow to claim a free key.
...
No paywall for developers. Out-feature the alternatives. A checkpoint UX users can trust.
